...
public class com_mobile_novi_model_ModelNovelRealmProxy extends com.mobile.novi.model.ModelNovel
    implements RealmObjectProxy, com_mobile_novi_model_ModelNovelRealmProxyInterface {
    ...
    private ProxyState<com.mobile.novi.model.ModelNovel> proxyState;

    com_mobile_novi_model_ModelNovelRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.mobile.novi.model.ModelNovel>(this);
    ...
    @SuppressWarnings("cast")
    public static com.mobile.novi.model.ModelNovel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.mobile.novi.model.ModelNovel obj = realm.createObjectInternal(com.mobile.novi.model.ModelNovel.class, true, excludeFields);

        final com_mobile_novi_model_ModelNovelRealmProxyInterface objProxy = (com_mobile_novi_model_ModelNovelRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.mobile.novi.model.ModelNovel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.mobile.novi.model.ModelNovel obj = new com.mobile.novi.model.ModelNovel();
        final com_mobile_novi_model_ModelNovelRealmProxyInterface objProxy = (com_mobile_novi_model_ModelNovelRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.mobile.novi.model.ModelNovel copyOrUpdate(Realm realm, com.mobile.novi.model.ModelNovel object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.mobile.novi.model.ModelNovel) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.mobile.novi.model.ModelNovel copy(Realm realm, com.mobile.novi.model.ModelNovel newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.mobile.novi.model.ModelNovel realmObject = realm.createObjectInternal(com.mobile.novi.model.ModelNovel.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_mobile_novi_model_ModelNovelRealmProxyInterface realmObjectSource = (com_mobile_novi_model_ModelNovelRealmProxyInterface) newObject;
        com_mobile_novi_model_ModelNovelRealmProxyInterface realmObjectCopy = (com_mobile_novi_model_ModelNovelRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.mobile.novi.model.ModelNovel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mobile.novi.model.ModelNovel.class);
        long tableNativePtr = table.getNativePtr();
        ModelNovelColumnInfo columnInfo = (ModelNovelColumnInfo) realm.getSchema().getColumnInfo(com.mobile.novi.model.ModelNovel.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Title = ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$Title();
        if (realmGet$Title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.TitleIndex, rowIndex, realmGet$Title, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_mobile_novi_model_ModelNovelRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelNovelColumnInfo columnInfo = (ModelNovelColumnInfo) realm.getSchema().getColumnInfo(com.mobile.novi.model.ModelNovel.class);
        com.mobile.novi.model.ModelNovel object = null;
        while (objects.hasNext()) {
            object = (com.mobile.novi.model.ModelNovel) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.mobile.novi.model.ModelNovel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mobile.novi.model.ModelNovel.class);
    ...
    public static com.mobile.novi.model.ModelNovel createDetachedCopy(com.mobile.novi.model.ModelNovel realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.mobile.novi.model.ModelNovel unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.mobile.novi.model.ModelNovel();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.mobile.novi.model.ModelNovel) cachedObject.object;
            }
            unmanagedObject = (com.mobile.novi.model.ModelNovel) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_mobile_novi_model_ModelNovelRealmProxyInterface unmanagedCopy = (com_mobile_novi_model_ModelNovelRealmProxyInterface) unmanagedObject;
        com_mobile_novi_model_ModelNovelRealmProxyInterface realmSource = (com_mobile_novi_model_ModelNovelRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_mobile_novi_model_ModelNovelRealmProxy aModelNovel = (com_mobile_novi_model_ModelNovelRealmProxy)o;
