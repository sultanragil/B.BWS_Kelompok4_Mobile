...
import com.example.novi.adapter.AllCategoryAdapter;
import com.example.novi.model.AllCategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(AllCategory.this, com.example.novi.MainActivity.class);
                startActivity(back);
                finish();
            }
        });
